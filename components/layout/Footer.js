  ...
  return (
    <footer className="footer">
      <div className="footer-grid container">
        <div className="footer-brand">
          ...
          <a href={`mailto:${company.email}`}>
            {company.email} <ArrowUpRight size={16} />
          </a>
        ...
        <div className="footer-links">
          <span className="footer-label">
            {company.footerLabels.navigation}
          </span>
          {navLinks
        ...
        <div className="footer-links">
          ...
          <FooterServiceGroup
            item={category("penetration-testing")}
            limit={3}
          />
          <FooterServiceGroup
            item={category("governance-risk-compliance")}
            limit={3}
          />
        </div>
        ...
        <div className="footer-links">
          ...
          <FooterServiceGroup
            item={category("cybersecurity-operations")}
            limit={4}
          />
      ...
      <div className="footer-bottom container">
        <Image
          src="/assets/images/brand/aceinfluence-logo.png"
          alt={company.name}
          width={150}
          height={48}
        />
